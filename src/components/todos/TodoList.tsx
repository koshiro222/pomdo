...
export default function TodoList({ pomodoroCount = 0, targetPomodoros = 4 }: TodoListProps) {
  ...
  if (loading) {
    return (
      <div className="widget-light dark:widget rounded-2xl flex flex-col min-h-64 sm:h-full overflow-hidden p-6">
  ...
  return (
    <div className="widget-light dark:widget rounded-2xl flex flex-col min-h-64 sm:h-full overflow-hidden">
      {/* ヘッダー */}

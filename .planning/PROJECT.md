...
## Current Milestone: v1.6.1 BGMプレイヤーアニメーション刷新

**Goal:** BGM再生中のアルバムアートアニメーションを、点滅しながらパルスを発する表現に刷新する

**Target features:**
- 削除: 回転する円盤アニメーション (album-art-spinning)
- 追加: 点滅アニメーション（opacity/scale変化）
- 追加: パルスエフェクト（広がるglow/border）

## Current State

**Latest Milestone:** v1.6.1 BGMプレイヤーアニメーション刷新 (completed 2026-03-26)

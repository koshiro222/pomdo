...
- [x] **BGMAN-01**: アルバムアートが点滅する（opacity 0.6 ↔ 1.0, scale 1 ↔ 1.02, 2s周期）
- [x] **BGMAN-02**: アルバムアートからパルスが広がる（box-shadow多層構造によるglowエフェクト）
...
|-------------|-------|--------|
| BGMAN-01 | Phase 19 | Complete |
| BGMAN-02 | Phase 19 | Complete |
| BGMAN-03 | Phase 20 | Pending |
| BGMAN-04 | Phase 20 | Pending |

...
**Goal:** 全カードのヘッダーテキストスタイルと配置を統一し、視覚的一貫性を確保する

**Target features:**
- タイマーカードにヘッダーテキスト追加
- BGMカードのヘッダー左上・Listボタン右上配置
- TodoListカードのヘッダースタイル統一

## Current State

**Latest Milestone:** v1.4 Bento Grid再設計 & Todo統合 (shipped 2026-03-24)

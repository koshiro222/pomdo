...
- [ ] **A11Y-01**: ユーザーはWCAG AA基準（4.5:1）を満たすカラーコントラストでテキストを読める
- [ ] **A11Y-02**: ユーザーはキーボード操作時に明確なfocusスタイルを確認できる
- [ ] **A11Y-03**: ユーザーはドラッグハンドルをキーボードなしで認識できる（常時表示）
...
*Last updated: 2026-03-23 after v1.3 requirements definition*
